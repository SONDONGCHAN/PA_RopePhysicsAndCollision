...
PS_OUT PS_MAIN(PS_IN In)
{
	...
	vector		vSourDiffuse = g_DiffuseTexture[0].Sample(g_LinearSampler, In.vTexcoord * 51.3f);
	vector		vDestDiffuse = g_DiffuseTexture[1].Sample(g_LinearSampler, In.vTexcoord * 51.3f);
