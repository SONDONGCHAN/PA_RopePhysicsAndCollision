...
HRESULT CBody_Player::Render()
{
	...
	if (FAILED(m_pModelCom->Update_BoneMatrices(m_pShaderCom, "g_BoneMatrices")))
		return E_FAIL;
...
HRESULT CBody_Player::Add_Component()
{
	...
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Shader_VtxAnimNonMesh"),
		TEXT("Com_Shader"), reinterpret_cast<CComponent**>(&m_pShaderCom))))
		return E_FAIL;
